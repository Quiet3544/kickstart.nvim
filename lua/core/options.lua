...
vim.o.wrap = true -- linewrap
vim.o.linebreak = true --Doesnt split words
vim.o.mouse = 'a' -- enable mouse mode
vim.o.autoindent = true -- autoindent
vim.o.ignorecase = true -- Case-insesntivity searching
vim.o.smartcase = true -- smart case
vim.o.shiftwidth = 4 -- numbers of spaces after indentiation
vim.o.tabstop = 4 -- numbers of spaces per tab
